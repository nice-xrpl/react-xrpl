...
export function XRPLClientProvider({ client, children }: XRPLClientProps) {
	return <XRPLClientContext.Provider value={client}>{children}</XRPLClientContext.Provider>;
}
...
export function ClientStoreProvider({ state, children }: ClientStoreProviderProps) {
	return <ClientStoreContext.Provider value={state}>{children}</ClientStoreContext.Provider>;
}